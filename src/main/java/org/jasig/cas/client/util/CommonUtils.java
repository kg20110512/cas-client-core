...
/**
    ...
    public static String getResponseFromServer(final URL constructedUrl, final HostnameVerifier hostnameVerifier, final String encoding) {
        ...
        LOG.debug("=== begin of getResponseFromServer " + constructedUrl.toString() + "===");
        try {
            ...
            LOG.debug("=== respone of getResponseFromServer = "+ stringBuffer.toString());
            ...
            LOG.debug("=== end of getResponseFromServer " + constructedUrl.toString() + "===");
        }
